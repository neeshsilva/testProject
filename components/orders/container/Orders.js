...
import {changeFilteringState, sendNotificationToken} from '../actions/orderActions';
import {forceLogout} from '../../login_logout/actions/loginLogoutActions';
import OrderList from './OrderList';
import {handleAndroidBackButton, navigateBack, removeAndroidBackButtonHandler} from '../../utils/navigationHandler';
                    ...
                    <View style={styles.upperComponent}>
                        <Text style={styles.title}>
                            ...
                            this.props.filteringState.length === 1
                                ? this.props.filteringState[0] === 'PENDING'? 'Notifications' : 'Orders'
                                : 'Orders'}
                        </Text>
                    </View>
